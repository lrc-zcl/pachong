...
爬取软科公办高职信息
"""
for pagedata in range(1, 35):
    urldata = f"https://www.shanghairanking.cn/rankings/bcvcr/2024623"
    header = {
    ...
    xlsxpath = "../data/gaozhi_gongban_info.xlsx"
    ...
    for signal_hotol in hotol_list:
        ...
        print(name_data, location_data, education_data, type_data)
        df = pd.read_excel(xlsxpath)
        new_data = {'Name': name_data, 'Location': location_data, 'Educational level': education_data,
                    'Type': type_data}
